...
public class TeacherChatDetailView {
    private BorderPane view = new BorderPane();
    private String studentName;

    public TeacherChatDetailView(String studentName) {
        ...
        backBtn.setOnMouseClicked(e -> App.showTeacherMessaging());
        ...
        Label status = new Label("\u25cf SECURE SESSION");
        ...
        Runnable sendMessage = () -> {
            ...
            if (!text.isEmpty()) {
                App.Message msg = new App.Message(App.currentTeacher.name, studentName, text, "Just now", false);
    ...
    private void renderMessages(VBox chatArea) {
        ...
        String key = studentName + ":" + App.currentTeacher.name;
    ...
    private HBox createMessageBubble(App.Message msg, VBox chatArea) {
        HBox row = new HBox();
        boolean isMine = msg.sender.equals(App.currentTeacher.name);
