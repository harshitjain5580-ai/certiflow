...
public class TeacherEditProfileView {
    ...
    public TeacherEditProfileView() {
        ...
        Label title = new Label("Update teacher identity");
        title.setStyle("-fx-text-fill: white; -fx-font-size: 32px; -fx-font-weight: bold;");
        Label subtitle = new Label("Modify your institutional profile details below.");
        ...
        TextField nameF = createField(form, "FULL NAME", App.currentTeacher.name);
        TextField roleF = createField(form, "INSTITUTIONAL ROLE", App.currentTeacher.role);
        TextField deptF = createField(form, "DEPARTMENT", App.currentTeacher.department);
        TextField emailF = createField(form, "OFFICIAL EMAIL", App.currentTeacher.email);
        TextField phoneF = createField(form, "OFFICE EXTENSION", App.currentTeacher.phone);
        ...
        saveBtn.setOnMouseClicked(e -> {
            App.currentTeacher.name = nameF.getText();
            App.currentTeacher.role = roleF.getText();
            App.currentTeacher.department = deptF.getText();
            App.currentTeacher.email = emailF.getText();
            App.currentTeacher.phone = phoneF.getText();
            App.saveDatabases();
            App.addNotification("\ud83d\udc64", "Profile Updated", "Your institutional identity has been updated successfully.");
        ...
        cancelBtn.setOnMouseClicked(e -> App.showTeacherProfile());
